// -->destructur is automatically used by compiler to delete constructor, but we qxcluly also used.
#include <iostream>
#include <string>
#include <vector>
...
int main()
{
    ...
    // Student s2 = s1;                                     //copy constructor make when object is declared
    // Student s2(s1);
